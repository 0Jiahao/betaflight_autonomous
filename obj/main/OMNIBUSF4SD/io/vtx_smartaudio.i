...
# 32 "./src/main/io/vtx_smartaudio.c" 2
...
# 22 "./src/main/cms/cms_menu_vtx_smartaudio.h" 2
...
# 61 "./src/main/io/vtx_smartaudio.c"
static serialPort_t *smartAudioSerialPort = 
# 61 "./src/main/io/vtx_smartaudio.c" 3 4
                                           ((void *)0)
# 61 "./src/main/io/vtx_smartaudio.c"
                                               ;
...
# 110 "./src/main/io/vtx_smartaudio.c"
...
# 146 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 146 "./src/main/io/vtx_smartaudio.c"
    saDeferred = 
# 146 "./src/main/io/vtx_smartaudio.c" 3 4
                 1
# 146 "./src/main/io/vtx_smartaudio.c"
...
# 198 "./src/main/io/vtx_smartaudio.c"
int saDacToPowerIndex(int dac)
{
...
# 474 "./src/main/io/vtx_smartaudio.c"
...
# 514 "./src/main/io/vtx_smartaudio.c"
static 
# 514 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 514 "./src/main/io/vtx_smartaudio.c"
           saQueueEmpty(void)
{
...
static 
# 519 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 519 "./src/main/io/vtx_smartaudio.c"
           saQueueFull(void)
{
...
static 
# 554 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 554 "./src/main/io/vtx_smartaudio.c"
...
# 609 "./src/main/io/vtx_smartaudio.c"
static 
# 609 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 609 "./src/main/io/vtx_smartaudio.c"
...
# 665 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 665 "./src/main/io/vtx_smartaudio.c"
    vtxSmartAudioInit(void)
{
# 677 "./src/main/io/vtx_smartaudio.c"
...
# 686 "./src/main/io/vtx_smartaudio.c"
    ...
    if (!smartAudioSerialPort) {
        return 
# 690 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 690 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    return 
# 695 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 695 "./src/main/io/vtx_smartaudio.c"
              ;
}
...
static void vtxSAProcess(vtxDevice_t *vtxDevice, timeUs_t currentTimeUs)
{
    ...
    if (smartAudioSerialPort == 
# 710 "./src/main/io/vtx_smartaudio.c" 3 4
                               ((void *)0)
# 710 "./src/main/io/vtx_smartaudio.c"
                                   ) {
        return;
    }
...
static 
# 784 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 784 "./src/main/io/vtx_smartaudio.c"
           vtxSAIsReady(const vtxDevice_t *vtxDevice)
{
    return vtxDevice!=
# 786 "./src/main/io/vtx_smartaudio.c" 3 4
                     ((void *)0) 
# 786 "./src/main/io/vtx_smartaudio.c"
                          && !(saDevice.version == 0);
}
...
# 879 "./src/main/io/vtx_smartaudio.c"
    ...
    *pFreq = (saDevice.mode & 1) ? saDevice.freq :
        ...
        ((saDevice.channel) % (uint8_t)8) + 1);
    return 
# 886 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 886 "./src/main/io/vtx_smartaudio.c"
              ;
}
