...
# 30 "./src/main/io/transponder_ir.c" 2
...
# 32 "./src/main/io/transponder_ir.c" 2
...
# 36 "./src/main/io/transponder_ir.c" 2
...
# 21 "./src/main/io/transponder_ir.h" 2
...
# 41 "./src/main/io/transponder_ir.c" 2
...
static 
# 61 "./src/main/io/transponder_ir.c" 3 4
      _Bool 
# 61 "./src/main/io/transponder_ir.c"
...
# 61 "./src/main/io/transponder_ir.c"
                                         ;
static 
# 62 "./src/main/io/transponder_ir.c" 3 4
      _Bool 
# 62 "./src/main/io/transponder_ir.c"
           transponderRepeat = 
# 62 "./src/main/io/transponder_ir.c" 3 4
                               0
# 62 "./src/main/io/transponder_ir.c"
...
void transponderUpdate(timeUs_t currentTimeUs)
{
    ...
    const 
# 84 "./src/main/io/transponder_ir.c" 3 4
         _Bool 
# 84 "./src/main/io/transponder_ir.c"
...
# 106 "./src/main/io/transponder_ir.c"
...
{
    transponderRepeat = 
# 121 "./src/main/io/transponder_ir.c" 3 4
                       0
# 121 "./src/main/io/transponder_ir.c"
                            ;
}
...
void transponderStartRepeating(void)
{
    ...
    transponderRepeat = 
# 130 "./src/main/io/transponder_ir.c" 3 4
                       1
# 130 "./src/main/io/transponder_ir.c"
                           ;
}
