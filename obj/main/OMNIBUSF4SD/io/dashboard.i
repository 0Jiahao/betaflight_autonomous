...
static 
# 83 "./src/main/io/dashboard.c" 3 4
      _Bool 
...
# 116 "./src/main/io/dashboard.c" 3 4
   _Bool 
# 116 "./src/main/io/dashboard.c"
        pageChanging;
...
static void showWelcomePage(void)
{
    ...
    tfp_sprintf(lineBuffer, "v%s (%s)", "3" "." "3" "." "1", shortGitRevision);
...
# 624 "./src/main/io/dashboard.c" 3 4
   _Bool 
# 624 "./src/main/io/dashboard.c"
...
# 633 "./src/main/io/dashboard.c" 3 4
                                1
# 633 "./src/main/io/dashboard.c"
                                    ;
    } else {
        if (armedStateChanged) {
            pageState.pageFlags |= PAGE_STATE_FLAG_FORCE_PAGE_CHANGE;
