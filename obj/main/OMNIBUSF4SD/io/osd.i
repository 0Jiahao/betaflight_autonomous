...
# 103 "./src/main/io/osd.c"
                            ;
static 
# 104 "./src/main/io/osd.c" 3 4
      _Bool 
# 104 "./src/main/io/osd.c"
           showVisualBeeper = 
# 104 "./src/main/io/osd.c" 3 4
                              0
# 104 "./src/main/io/osd.c"
...
# 233 "./src/main/io/osd.c" 3 4
                                                              _Bool 
# 233 "./src/main/io/osd.c"
                                                                   pad)
{
...
# 322 "./src/main/io/osd.c" 3 4
                                                  _Bool 
# 322 "./src/main/io/osd.c"
...
static 
# 357 "./src/main/io/osd.c" 3 4
      _Bool 
# 357 "./src/main/io/osd.c"
           osdFormatRtcDateTime(char *buffer)
{
    ...
    if (!rtcGetDateTime(&dateTime)) {
        ...
        return 
# 363 "./src/main/io/osd.c" 3 4
              0
# 363 "./src/main/io/osd.c"
                   ;
    }
...
# 385 "./src/main/io/osd.c"
    ...
    case OSD_GPS_LAT:
        osdFormatCoordinate(buff, 0xCA, gpsSol.llh.lat);
        break;

    case OSD_GPS_LON:
        osdFormatCoordinate(buff, 0xCB, gpsSol.llh.lon);
        break;
...
# 478 "./src/main/io/osd.c" 3 4
                                                             1
# 478 "./src/main/io/osd.c"
                                                                 );
        break;
    ...
    case OSD_FLYMODE:
        {
            ...
            return 
# 518 "./src/main/io/osd.c" 3 4
                  1
# 518 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_ARTIFICIAL_HORIZON:
        {
            ...
            return 
# 600 "./src/main/io/osd.c" 3 4
                  1
# 600 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_HORIZON_SIDEBARS:
        {
            ...
            return 
# 623 "./src/main/io/osd.c" 3 4
                  1
# 623 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_WARNINGS:
        {
            ...
            osdFormatMessage(buff, (11 + 1), 
# 700 "./src/main/io/osd.c" 3 4
                                                                  ((void *)0)
# 700 "./src/main/io/osd.c"
                                                                      );
            break;
        }
...
# 777 "./src/main/io/osd.c" 3 4
                                           ((void *)0) 
# 777 "./src/main/io/osd.c"
                                                ? 0 : escData->rpm);
        break;
    ...
    default:
        return 
# 800 "./src/main/io/osd.c" 3 4
              0
# 800 "./src/main/io/osd.c"
                   ;
    }
    ...
    return 
# 805 "./src/main/io/osd.c" 3 4
          1
# 805 "./src/main/io/osd.c"
              ;
}
...
# 895 "./src/main/io/osd.c" 3 4
                                                        1
# 895 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_MAX_ALTITUDE] = 
# 896 "./src/main/io/osd.c" 3 4
                                                        0
# 896 "./src/main/io/osd.c"
                                                             ;
    osdConfig->enabled_stats[OSD_STAT_BLACKBOX] = 
# 897 "./src/main/io/osd.c" 3 4
                                                        1
# 897 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_END_BATTERY] = 
# 898 "./src/main/io/osd.c" 3 4
                                                        0
# 898 "./src/main/io/osd.c"
                                                             ;
...
# 900 "./src/main/io/osd.c" 3 4
                                                        1
# 900 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_TIMER_1] = 
# 901 "./src/main/io/osd.c" 3 4
                                                        0
# 901 "./src/main/io/osd.c"
                                                             ;
    osdConfig->enabled_stats[OSD_STAT_TIMER_2] = 
# 902 "./src/main/io/osd.c" 3 4
                                                        1
# 902 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_RTC_DATE_TIME] = 
# 903 "./src/main/io/osd.c" 3 4
                                                        0
# 903 "./src/main/io/osd.c"
                                                             ;
...
# 908 "./src/main/io/osd.c" 3 4
                                (0xffff)
# 908 "./src/main/io/osd.c"
                                          ;
...
void osdInit(displayPort_t *osdDisplayPortToUse)
{
    ...
    tfp_sprintf(string_buffer, "V%s", "3" "." "3" "." "1");
...
static void osdUpdateStats(void)
{
    ...
    if ((stateFlags & (GPS_FIX)) && (stateFlags & (GPS_FIX_HOME)) && (stats.max_distance < GPS_distanceToHome)) {
...
# 1097 "./src/main/io/osd.c" 3 4
   _Bool 
# 1097 "./src/main/io/osd.c"
...
static 
# 1146 "./src/main/io/osd.c" 3 4
      _Bool 
# 1146 "./src/main/io/osd.c"
           isSomeStatEnabled(void)
{
    for (int i = 0; i < OSD_STAT_COUNT; i++) {
        if (osdConfig()->enabled_stats[i]) {
            return 
# 1150 "./src/main/io/osd.c" 3 4
                  1
# 1150 "./src/main/io/osd.c"
                      ;
        }
    }
    return 
# 1153 "./src/main/io/osd.c" 3 4
          0
# 1153 "./src/main/io/osd.c"
               ;
}
...
# 1165 "./src/main/io/osd.c"
    ...
    if (osdConfig()->enabled_stats[OSD_STAT_TIMER_1]) {
        osdFormatTimer(buff, 
# 1177 "./src/main/io/osd.c" 3 4
                            0
# 1177 "./src/main/io/osd.c"
                                 , OSD_TIMER_1);
    ...
    if (osdConfig()->enabled_stats[OSD_STAT_TIMER_2]) {
        osdFormatTimer(buff, 
# 1182 "./src/main/io/osd.c" 3 4
                            0
# 1182 "./src/main/io/osd.c"
                                 , OSD_TIMER_2);
...
# 1226 "./src/main/io/osd.c" 3 4
                                                         0
# 1226 "./src/main/io/osd.c"
                                                              );
...
void osdUpdate(timeUs_t currentTimeUs)
{
    ...
    if (isBeeperOn()) {
        showVisualBeeper = 
# 1325 "./src/main/io/osd.c" 3 4
                          1
# 1325 "./src/main/io/osd.c"
                              ;
    }
# 1352 "./src/main/io/osd.c"
    if (counter % 5 == 0) {
        osdRefresh(currentTimeUs);
        showVisualBeeper = 
# 1354 "./src/main/io/osd.c" 3 4
                          0
# 1354 "./src/main/io/osd.c"
                               ;
    } else {
