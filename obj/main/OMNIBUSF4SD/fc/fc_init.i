...
# 163 "./src/main/fc/fc_init.c"
uint8_t systemState = SYSTEM_STATE_INITIALISING;

void processLoopback(void)
{
# 176 "./src/main/fc/fc_init.c"
}
# 197 "./src/main/fc/fc_init.c"
void spiPreInit(void)
{

    spiPreInitCs(((ioTag_t)((((0) + 1) << 4) | (4))));


    spiPreInitCs(((ioTag_t)((((0) + 1) << 4) | (4))));
# 221 "./src/main/fc/fc_init.c"
    spiPreInitCsOutPU(((ioTag_t)((((0) + 1) << 4) | (15))));


    spiPreInitCs(sdcardConfig()->chipSelectTag);


    spiPreInitCs(((ioTag_t)((((1) + 1) << 4) | (3))));
# 250 "./src/main/fc/fc_init.c"
}


void init(void)
{
# 267 "./src/main/fc/fc_init.c"
    printfSupportInit();
...
# 282 "./src/main/fc/fc_init.c"
    ...
    if (strncasecmp(systemConfig()->boardIdentifier, "OBSD", sizeof("OBSD"))) {
        resetEEPROM();
    }
    ...
    ledSet(2, 
# 308 "./src/main/fc/fc_init.c" 3 4
   1
# 308 "./src/main/fc/fc_init.c"
   );
...
# 456 "./src/main/fc/fc_init.c"
    i2cInit(I2CDEV_2);


    i2cInit(I2CDEV_3);
# 477 "./src/main/fc/fc_init.c"
    cameraControlInit();
# 495 "./src/main/fc/fc_init.c"
...
# 538 "./src/main/fc/fc_init.c"
    ...
    ledSet(2, 
# 539 "./src/main/fc/fc_init.c" 3 4
   0
# 539 "./src/main/fc/fc_init.c"
   );
...
# 545 "./src/main/fc/fc_init.c" 3 4
                                                                    1
# 545 "./src/main/fc/fc_init.c"
                                                                    );
        delay(25);
        systemBeep(
# 547 "./src/main/fc/fc_init.c" 3 4
       0
# 547 "./src/main/fc/fc_init.c"
       );
    }
    ledSet(0, 
...
# 549 "./src/main/fc/fc_init.c"
    ...
    ledSet(1, 
# 550 "./src/main/fc/fc_init.c" 3 4
   0
# 550 "./src/main/fc/fc_init.c"
   );
...
# 573 "./src/main/fc/fc_init.c" 3 4
                                   ((void *)0)
# 573 "./src/main/fc/fc_init.c"
                                       ;
...
# 685 "./src/main/fc/fc_init.c" 3 4
                        0
# 685 "./src/main/fc/fc_init.c"
                             );
    ...
    vtxTrampInit();
# 719 "./src/main/fc/fc_init.c"
    timerStart();

    (stateFlags |= (SMALL_ANGLE));
# 732 "./src/main/fc/fc_init.c"
    batteryInit();
