        ...
        switch (id) {
            case FSSP_DATAID_VFAS :
                if (isBatteryVoltageConfigured()) {
                    ...
                    *clearToSend = 
# 388 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 388 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_CURRENT :
                if (isAmperageConfigured()) {
                    ...
                    *clearToSend = 
# 394 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 394 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
...
# 401 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_FUEL :
                if (isAmperageConfigured()) {
                    ...
                    *clearToSend = 
# 407 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 407 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_VARIO :
                if (sensors(SENSOR_BARO)) {
                    ...
                    *clearToSend = 
# 416 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 416 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_HEADING :
                ...
                *clearToSend = 
# 421 "./src/main/telemetry/smartport.c" 3 4
                              0
# 421 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCX :
                smartPortSendPackage(id, 100 * acc.accADC[X] / acc.dev.acc_1G);
                *clearToSend = 
# 425 "./src/main/telemetry/smartport.c" 3 4
                              0
# 425 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCY :
                smartPortSendPackage(id, 100 * acc.accADC[Y] / acc.dev.acc_1G);
                *clearToSend = 
# 429 "./src/main/telemetry/smartport.c" 3 4
                              0
# 429 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCZ :
                smartPortSendPackage(id, 100 * acc.accADC[Z] / acc.dev.acc_1G);
                *clearToSend = 
# 433 "./src/main/telemetry/smartport.c" 3 4
                              0
# 433 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_T1 :
...
# 479 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_T2 :
                if (sensors(SENSOR_GPS)) {
                    ...
                    *clearToSend = 
# 486 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 486 "./src/main/telemetry/smartport.c"
                                       ;

                } else if (feature(FEATURE_GPS)) {
                    smartPortSendPackage(id, 0);
                    *clearToSend = 
# 490 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 490 "./src/main/telemetry/smartport.c"
                                       ;
                    ...
                    *clearToSend = 
# 520 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 520 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_SPEED :
                if (sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX))) {
                    ...
                    *clearToSend = 
# 530 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 530 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
...
# 550 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_HOME_DIST :
                if (sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX))) {
                     ...
                     *clearToSend = 
# 556 "./src/main/telemetry/smartport.c" 3 4
                                   0
# 556 "./src/main/telemetry/smartport.c"
                                        ;
                }
                break;
            case FSSP_DATAID_GPS_ALT :
                if (sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX))) {
                    ...
                    *clearToSend = 
# 562 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 562 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_A4 :
                if (isBatteryVoltageConfigured()) {
                    const uint8_t cellCount = getBatteryCellCount();
                    const uint32_t vfasVoltage = cellCount ? (getBatteryVoltage() * 10 / cellCount) : 0;
                    smartPortSendPackage(id, vfasVoltage);
                    *clearToSend = 
# 571 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 571 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
...
{
    static 
# 591 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 591 "./src/main/telemetry/smartport.c"
               clearToSend = 
# 591 "./src/main/telemetry/smartport.c" 3 4
                             0
# 591 "./src/main/telemetry/smartport.c"
...
# 593 "./src/main/telemetry/smartport.c" 3 4
                                        ((void *)0)
# 593 "./src/main/telemetry/smartport.c"
                                            ;
...
# 600 "./src/main/telemetry/smartport.c" 3 4
                                                                                  1
# 600 "./src/main/telemetry/smartport.c"
                                                                                      );
            if (payload) {
