...
# 82 "./src/main/io/spektrum_vtx_control.h"
typedef struct
{
    uint8_t band;
    uint8_t channel;
...
# 74 "./src/main/telemetry/srxl.c"
static 
# 74 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 74 "./src/main/telemetry/srxl.c"
...
# 118 "./src/main/telemetry/srxl.c"

# 118 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 118 "./src/main/telemetry/srxl.c"
    srxlFrameQos(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    return 
# 127 "./src/main/telemetry/srxl.c" 3 4
          1
# 127 "./src/main/telemetry/srxl.c"
              ;
}
# 146 "./src/main/telemetry/srxl.c"

# 146 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 146 "./src/main/telemetry/srxl.c"
    srxlFrameRpm(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    sbufFill(dst, 0xFF, 8);
    return 
# 157 "./src/main/telemetry/srxl.c" 3 4
          1
# 157 "./src/main/telemetry/srxl.c"
              ;
}
# 177 "./src/main/telemetry/srxl.c"

# 177 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 177 "./src/main/telemetry/srxl.c"
    srxlFrameFlightPackCurrent(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    if ( (amps != sentAmps) || (mah != sentMah) ||
        ...
        return 
# 202 "./src/main/telemetry/srxl.c" 3 4
              1
# 202 "./src/main/telemetry/srxl.c"
                  ;
    }
    return 
# 204 "./src/main/telemetry/srxl.c" 3 4
          0
# 204 "./src/main/telemetry/srxl.c"
               ;
}
# 229 "./src/main/telemetry/srxl.c"
static char srxlTextBuff[(9)][(13)];
static 
# 230 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 230 "./src/main/telemetry/srxl.c"
           lineSent[(9)];
...
int spektrumTmTextGenPutChar(uint8_t col, uint8_t row, char c)
{
    if (row < 9 && col < 12) {
        ...
        if (srxlTextBuff[row][col] != c) {
          ...
          lineSent[row] = 
# 241 "./src/main/telemetry/srxl.c" 3 4
                         0
# 241 "./src/main/telemetry/srxl.c"
                              ;
        }
    }
    return 0;
...
# 248 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 248 "./src/main/telemetry/srxl.c"
    srxlFrameText(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    lineSent[lineNo] = 
# 266 "./src/main/telemetry/srxl.c" 3 4
                      1
# 266 "./src/main/telemetry/srxl.c"
                          ;
    lineNo = (lineNo + 1) % (9);
    ...
    return 
# 272 "./src/main/telemetry/srxl.c" 3 4
          1
# 272 "./src/main/telemetry/srxl.c"
              ;
}
...
# 307 "./src/main/telemetry/srxl.c" 3 4
                                         ((void *)0)
# 307 "./src/main/telemetry/srxl.c"
                                             ;
...
# 331 "./src/main/telemetry/srxl.c"
        ...
        if (powerIndexTable != 
# 338 "./src/main/telemetry/srxl.c" 3 4
                              ((void *)0)
# 338 "./src/main/telemetry/srxl.c"
                                  ) {
            for (int i = 0; i < 8; i++)
...
# 382 "./src/main/telemetry/srxl.c"
static 
# 382 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 382 "./src/main/telemetry/srxl.c"
           srxlFrameVTX(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    if ((vtxDeviceType != VTXDEV_UNKNOWN) && vtxDeviceType != VTXDEV_UNSUPPORTED) {
        ...
        if ((memcmp(&vtxSent, &vtx, sizeof(spektrumVtx_t)) != 0) ||
            ...
            return 
# 409 "./src/main/telemetry/srxl.c" 3 4
                  1
# 409 "./src/main/telemetry/srxl.c"
                      ;
        }
    }
    return 
# 412 "./src/main/telemetry/srxl.c" 3 4
          0
# 412 "./src/main/telemetry/srxl.c"
               ;
}
# 442 "./src/main/telemetry/srxl.c"
typedef 
# 442 "./src/main/telemetry/srxl.c" 3 4
       _Bool 
# 442 "./src/main/telemetry/srxl.c"
...
# 500 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 500 "./src/main/telemetry/srxl.c"
    checkSrxlTelemetryState(void)
{
