...
# 64 "./src/main/telemetry/ibus_shared.c"
...
# 124 "./src/main/telemetry/ibus_shared.c" 3 4
                                     ((void *)0)
# 124 "./src/main/telemetry/ibus_shared.c"
                                         ;
...
static 
# 288 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 288 "./src/main/telemetry/ibus_shared.c"
           setGPS(uint8_t sensorType, ibusTelemetry_s* value)
{
    
# 290 "./src/main/telemetry/ibus_shared.c" 3 4
   _Bool 
# 290 "./src/main/telemetry/ibus_shared.c"
        result = 
# 290 "./src/main/telemetry/ibus_shared.c" 3 4
                 0
# 290 "./src/main/telemetry/ibus_shared.c"
    ...
    for (unsigned i = 0; i < sizeof(GPS_IDS); i++) {
        if (sensorType == GPS_IDS[i]) {
            result = 
# 293 "./src/main/telemetry/ibus_shared.c" 3 4
                    1
# 293 "./src/main/telemetry/ibus_shared.c"
                        ;
            break;
        }
    }
    ...
    if (sensors(SENSOR_GPS)) {
        ...
        if ((stateFlags & (GPS_FIX)) || sensorType == IBUS_SENSOR_TYPE_GPS_STATUS) {
            result = 
# 305 "./src/main/telemetry/ibus_shared.c" 3 4
                    1
# 305 "./src/main/telemetry/ibus_shared.c"
                        ;
            switch (sensorType) {
...
static 
# 445 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 445 "./src/main/telemetry/ibus_shared.c"
...
static 
# 463 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 463 "./src/main/telemetry/ibus_shared.c"
