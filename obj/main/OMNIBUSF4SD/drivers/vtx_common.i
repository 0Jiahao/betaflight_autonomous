...
# 91 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 91 "./src/main/drivers/vtx_common.c"
    vtxCommonGetBandAndChannel(const vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel)
{
...
# 96 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 96 "./src/main/drivers/vtx_common.c"
    vtxCommonGetPowerIndex(const vtxDevice_t *vtxDevice, uint8_t *pIndex)
{
...
# 101 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 101 "./src/main/drivers/vtx_common.c"
    vtxCommonGetPitMode(const vtxDevice_t *vtxDevice, uint8_t *pOnOff)
{
