...
# 162 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 162 "./src/main/drivers/barometer/barometer_bmp085.c"
...
# 162 "./src/main/drivers/barometer/barometer_bmp085.c"
    ...
    if (bmp085InitDone)
        return 
# 169 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              1
# 169 "./src/main/drivers/barometer/barometer_bmp085.c"
                  ;

    bmp085InitXclrIO(config);
    ;
# 185 "./src/main/drivers/barometer/barometer_bmp085.c"
    (void)(config);
...
# 218 "./src/main/drivers/barometer/barometer_bmp085.c"
                                ;
            return 
# 219 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                  1
# 219 "./src/main/drivers/barometer/barometer_bmp085.c"
                      ;
        }
    }
...
{
    uint8_t data[2];
# 309 "./src/main/drivers/barometer/barometer_bmp085.c"
...
{
    uint8_t data[3];
# 341 "./src/main/drivers/barometer/barometer_bmp085.c"
