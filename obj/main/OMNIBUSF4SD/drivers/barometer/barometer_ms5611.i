...
# 26 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 28 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 33 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 34 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 49 "./src/main/drivers/barometer/barometer_ms5611.c"
...
{
# 74 "./src/main/drivers/barometer/barometer_ms5611.c"
    (void)(busdev);
...
# 91 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
_Bool 
# 91 "./src/main/drivers/barometer/barometer_ms5611.c"
    ms5611Detect(baroDev_t *baro)
{
    uint8_t sig;
    int i;
    
# 95 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
   _Bool 
# 95 "./src/main/drivers/barometer/barometer_ms5611.c"
...
# 95 "./src/main/drivers/barometer/barometer_ms5611.c"
    ...
    if ((busdev->bustype == BUSTYPE_I2C) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 106 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                               1
# 106 "./src/main/drivers/barometer/barometer_ms5611.c"
                                   ;
    }
    ...
    return 
# 133 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 133 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
...
fail:;
    ...
    return 
# 142 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          0
# 142 "./src/main/drivers/barometer/barometer_ms5611.c"
               ;
}
...
# 168 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
   _Bool 
# 168 "./src/main/drivers/barometer/barometer_ms5611.c"
        blankEeprom = 
# 168 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                      1
# 168 "./src/main/drivers/barometer/barometer_ms5611.c"
    ...
    for (i = 0; i < 16; i++) {
        if (prom[i >> 1]) {
            blankEeprom = 
# 172 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                         0
# 172 "./src/main/drivers/barometer/barometer_ms5611.c"
                              ;
        }
        if (i & 1)
            res ^= ((prom[i >> 1]) & 0x00FF);
