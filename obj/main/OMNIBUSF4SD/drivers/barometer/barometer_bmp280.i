...
void bmp280BusDeinit(busDevice_t *busdev)
{
    ...
    if (busdev->bustype == BUSTYPE_SPI) {
        IOConfigGPIO(busdev->busdev_u.spi.csnPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));
...
# 100 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
   _Bool 
# 100 "./src/main/drivers/barometer/barometer_bmp280.c"
...
# 100 "./src/main/drivers/barometer/barometer_bmp280.c"
    ...
    if ((busdev->bustype == BUSTYPE_I2C) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 107 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                               1
# 107 "./src/main/drivers/barometer/barometer_bmp280.c"
                                   ;
    }
...
# 117 "./src/main/drivers/barometer/barometer_bmp280.c"
    ...
    return 
# 136 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 136 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
