...
{
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), add);
    return spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), data);
}
...
# 354 "./src/main/drivers/max7456.c"
    ...
    {spiSetDivisor(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), max7456SpiClock);IOLo(max7456CsPin);};
    ...
    {IOHi(max7456CsPin);spiSetDivisor(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), (SPI_CLOCK_FAST));};
                                                                                            ...
                                                                                            cpuOverclock)
{
    ...
    max7456CsPin = IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (15))));

    IOInit(max7456CsPin, OWNER_OSD_CS, 0);
    IOConfigGPIO(max7456CsPin, ((GPIO_Mode_OUT) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    IOHi(max7456CsPin);



    spiSetDivisor(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), (SPI_CLOCK_STANDARD) * 2);
    ...
    spiSetDivisor(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), max7456SpiClock);
...
# 558 "./src/main/drivers/max7456.c"
        ...
        if (buff_len) {
            ...
            {spiSetDivisor(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), max7456SpiClock);IOLo(max7456CsPin);};
            spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), spiBuff, 
