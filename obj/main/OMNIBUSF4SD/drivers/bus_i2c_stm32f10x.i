...
# 46 "./src/main/drivers/bus_i2c_impl.h"
...
typedef struct i2cState_s {
    volatile 
# 62 "./src/main/drivers/bus_i2c_impl.h" 3 4
            _Bool 
# 62 "./src/main/drivers/bus_i2c_impl.h"
                 error;
    volatile 
# 63 "./src/main/drivers/bus_i2c_impl.h" 3 4
            _Bool 
# 63 "./src/main/drivers/bus_i2c_impl.h"
                 busy;
...
# 83 "./src/main/drivers/bus_i2c_impl.h" 3 4
   _Bool 
# 83 "./src/main/drivers/bus_i2c_impl.h"
        overClock;
    
# 84 "./src/main/drivers/bus_i2c_impl.h" 3 4
   _Bool 
# 84 "./src/main/drivers/bus_i2c_impl.h"
        pullUp;
...
# 48 "./src/main/drivers/bus_i2c_stm32f10x.c"
const i2cHardware_t i2cHardware[3] = {
# 67 "./src/main/drivers/bus_i2c_stm32f10x.c"
    {
        .device = I2CDEV_2,
...
static 
# 142 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
      _Bool 
# 142 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
# 150 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 150 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len_, uint8_t *data)
{
    if (device == I2CINVALID || device > 3) {
        return 
# 153 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 153 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (!I2Cx) {
        return 
# 159 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 159 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
...
# 193 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 193 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
# 198 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 198 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cRead(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len, uint8_t* buf)
{
    if (device == I2CINVALID || device > 3) {
        return 
# 201 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 201 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
...
static void i2c_er_handler(I2CDevice device) {
    ...
    if (SR1Register & 0x0F00)
        state->error = 
# 251 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                      1
# 251 "./src/main/drivers/bus_i2c_stm32f10x.c"
                          ;
