...
# 148 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 148 "./src/main/drivers/serial_softserial.c"
                                            ;
...
static void serialInputPortDeActivate(softSerial_t *softSerial)
{
    ...
    softSerial->rxActive = 
# 167 "./src/main/drivers/serial_softserial.c" 3 4
                          0
# 167 "./src/main/drivers/serial_softserial.c"
                               ;
}
...
static 
# 194 "./src/main/drivers/serial_softserial.c" 3 4
      _Bool 
# 194 "./src/main/drivers/serial_softserial.c"
...
serialPort_t *openSoftSerial(softSerialPortIndex_e portIndex, serialReceiveCallbackPtr rxCallback, void *rxCallbackData, uint32_t baud, portMode_e mode, portOptions_e options)
{
    ...
    if (options & SERIAL_BIDIR) {
        ...
        if (!timerTx || (timerTx->output & TIMER_OUTPUT_N_CHANNEL)) {
            return 
# 253 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 253 "./src/main/drivers/serial_softserial.c"
                      ;
        }
        ...
        if (mode & MODE_RX) {
            ...
            if (!timerRx || (timerRx->output & TIMER_OUTPUT_N_CHANNEL)) {
                return 
# 264 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 264 "./src/main/drivers/serial_softserial.c"
                          ;
            }
        ...
        if (mode & MODE_TX) {
            ...
            if (!tagTx)
                return 
# 275 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 275 "./src/main/drivers/serial_softserial.c"
                          ;
            ...
            if (!(mode & MODE_RX)) {
                ...
                if (!timerTx)
                    return 
# 282 "./src/main/drivers/serial_softserial.c" 3 4
                          ((void *)0)
# 282 "./src/main/drivers/serial_softserial.c"
                              ;
                softSerial->timerHardware = timerTx;
            } else {
...
# 312 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1 
# 312 "./src/main/drivers/serial_softserial.c"
                                                                                              : 
# 312 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                0
# 312 "./src/main/drivers/serial_softserial.c"
...
# 326 "./src/main/drivers/serial_softserial.c" 3 4
                                                           ((void *)0)
# 326 "./src/main/drivers/serial_softserial.c"
                                                               , &softSerial->overCb);
...
void processTxState(softSerial_t *softSerial)
{
    ...
    if (!softSerial->isTransmittingData) {
        ...
        softSerial->isTransmittingData = 
# 376 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 376 "./src/main/drivers/serial_softserial.c"
                                            ;
    ...
    softSerial->isTransmittingData = 
# 401 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 401 "./src/main/drivers/serial_softserial.c"
                                         ;
}
...
void prepareForNextRxByte(softSerial_t *softSerial)
{
    ...
    softSerial->rxBitIndex = 0;
    softSerial->isSearchingForStartBit = 
# 423 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 423 "./src/main/drivers/serial_softserial.c"
                                            ;
...
# 485 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 485 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 485 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 485 "./src/main/drivers/serial_softserial.c"
...
# 498 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 498 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 498 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 498 "./src/main/drivers/serial_softserial.c"
...
# 499 "./src/main/drivers/serial_softserial.c" 3 4
   _Bool 
# 499 "./src/main/drivers/serial_softserial.c"
...
# 524 "./src/main/drivers/serial_softserial.c" 3 4
                                                       0 
# 524 "./src/main/drivers/serial_softserial.c"
                                                                          : 
# 524 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1
# 524 "./src/main/drivers/serial_softserial.c"
...
# 533 "./src/main/drivers/serial_softserial.c" 3 4
                                      0
# 533 "./src/main/drivers/serial_softserial.c"
                                           ;
        return;
    }
...
# 625 "./src/main/drivers/serial_softserial.c" 3 4
_Bool 
# 625 "./src/main/drivers/serial_softserial.c"
...
# 638 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)
# 638 "./src/main/drivers/serial_softserial.c"
                   ,
    .beginWrite = 
# 639 "./src/main/drivers/serial_softserial.c" 3 4
                 ((void *)0)
# 639 "./src/main/drivers/serial_softserial.c"
                     ,
    .endWrite = 
# 640 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)
