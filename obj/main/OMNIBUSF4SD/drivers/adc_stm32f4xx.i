...
# 29 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 39 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 40 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 86 "./src/main/drivers/adc_stm32f4xx.c"
...
# 155 "./src/main/drivers/adc_stm32f4xx.c"
static 
# 155 "./src/main/drivers/adc_stm32f4xx.c" 3 4
      _Bool 
# 155 "./src/main/drivers/adc_stm32f4xx.c"
...
# 157 "./src/main/drivers/adc_stm32f4xx.c" 3 4
_Bool 
# 157 "./src/main/drivers/adc_stm32f4xx.c"
    adcInternalIsBusy(void)
{
    if (adcInternalConversionInProgress) {
        if (ADC_GetFlagStatus(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ((uint8_t)0x04)) != RESET) {
            adcInternalConversionInProgress = 
# 161 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                                             0
# 161 "./src/main/drivers/adc_stm32f4xx.c"
                                                  ;
        }
    }
...
void adcInternalStartConversion(void)
{
    ...
    adcInternalConversionInProgress = 
# 173 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                                     1
# 173 "./src/main/drivers/adc_stm32f4xx.c"
                                         ;
}
...
# 216 "./src/main/drivers/adc_stm32f4xx.c" 3 4
   _Bool 
# 216 "./src/main/drivers/adc_stm32f4xx.c"
        adcActive = 
# 216 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                    0
# 216 "./src/main/drivers/adc_stm32f4xx.c"
    ...
    for (int i = 0; i < ADC_CHANNEL_COUNT; i++) {
        ...
        adcActive = 
# 222 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                   1
# 222 "./src/main/drivers/adc_stm32f4xx.c"
                       ;
...
# 228 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                                       1
# 228 "./src/main/drivers/adc_stm32f4xx.c"
                                           ;
    }
