...
static uint8_t fportFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    static 
# 245 "./src/main/rx/fport.c" 3 4
          _Bool 
# 245 "./src/main/rx/fport.c"
               hasTelemetryRequest = 
# 245 "./src/main/rx/fport.c" 3 4
                                     0
# 245 "./src/main/rx/fport.c"
                ...
                case FPORT_FRAME_TYPE_TELEMETRY_REQUEST:
                    if (frameLength != (sizeof(uint8_t) + sizeof(smartPortPayload_t))) {
                        ...
                        case FPORT_FRAME_ID_DATA:
                            hasTelemetryRequest = 
# 285 "./src/main/rx/fport.c" 3 4
                                                 1
# 285 "./src/main/rx/fport.c"
                                                     ;
    ...
    if ((mspPayload || hasTelemetryRequest) && cmpTimeUs(micros(), lastTelemetryFrameReceivedUs) >= 500) {
        hasTelemetryRequest = 
# 315 "./src/main/rx/fport.c" 3 4
                             0
# 315 "./src/main/rx/fport.c"
                                  ;
...
static 
# 328 "./src/main/rx/fport.c" 3 4
      _Bool 
# 328 "./src/main/rx/fport.c"
           fportProcessFrame(const rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (cmpTimeUs(currentTimeUs, lastTelemetryFrameReceivedUs) > 2000) {
       clearToSend = 
# 335 "./src/main/rx/fport.c" 3 4
                    0
# 335 "./src/main/rx/fport.c"
                         ;
    }
...
# 341 "./src/main/rx/fport.c" 3 4
                                                           ((void *)0)
# 341 "./src/main/rx/fport.c"
                                                               );
        ...
        if (clearToSend) {
            ...
            clearToSend = 
# 346 "./src/main/rx/fport.c" 3 4
                         0
# 346 "./src/main/rx/fport.c"
                              ;
        }
    }

    mspPayload = 
# 350 "./src/main/rx/fport.c" 3 4
                ((void *)0)
# 350 "./src/main/rx/fport.c"
                    ;


    return 
# 353 "./src/main/rx/fport.c" 3 4
          1
# 353 "./src/main/rx/fport.c"
              ;
}
