...
{
    *(rxConfig) = (rxConfig_t) { .halfDuplex = 0, .serialrx_provider = 0, .rx_spi_protocol = 0, .serialrx_inverted = 0, .spektrum_bind_pin_override_ioTag = 0, .spektrum_bind_plug_ioTag = 0, .spektrum_sat_bind = 0, .spektrum_sat_bind_autoreset = 1, .midrc = 1500, .mincheck = 1050, .maxcheck = 1900, .rx_min_usec = 885, .rx_max_usec = 2115, .rssi_channel = 0, .rssi_scale = (4095.0f / 100.0f + 0.5f), .rssi_invert = 0, .rcInterpolation = RC_SMOOTHING_AUTO, .rcInterpolationChannels = 0, .rcInterpolationInterval = 19, .fpvCamAngleDegrees = 0, .airModeActivateThreshold = 32, .max_aux_channel = (18 - 4) };
# 153 "./src/main/rx/rx.c"
     ;
...
static 
# 207 "./src/main/rx/rx.c" 3 4
      _Bool 
# 207 "./src/main/rx/rx.c"
...
static 
# 214 "./src/main/rx/rx.c" 3 4
                  _Bool 
# 214 "./src/main/rx/rx.c"
...
# 221 "./src/main/rx/rx.c" 3 4
_Bool 
# 221 "./src/main/rx/rx.c"
    serialRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    
# 223 "./src/main/rx/rx.c" 3 4
   _Bool 
# 223 "./src/main/rx/rx.c"
        enabled = 
# 223 "./src/main/rx/rx.c" 3 4
                  0
# 223 "./src/main/rx/rx.c"
    ...
    default:
        enabled = 
# 279 "./src/main/rx/rx.c" 3 4
                 0
# 279 "./src/main/rx/rx.c"
                      ;
        break;
    }
    return enabled;
...
# 370 "./src/main/rx/rx.c" 3 4
_Bool 
# 370 "./src/main/rx/rx.c"
    rxAreFlightChannelsValid(void)
{
    ...
    rxUpdateCheck(timeUs_t currentTimeUs, timeDelta_t currentDeltaTime)
{
    ...
    if (rxSignalReceived) {
        if (currentTimeUs >= needRxSignalBefore) {
            rxSignalReceived = 
# 395 "./src/main/rx/rx.c" 3 4
                              0
# 395 "./src/main/rx/rx.c"
                                   ;
        }
    }
    ...
    if (feature(FEATURE_RX_PPM)) {
        if (isPPMDataBeingReceived()) {
            rxDataProcessingRequired = 
# 402 "./src/main/rx/rx.c" 3 4
                                      1
# 402 "./src/main/rx/rx.c"
                                          ;
            rxSignalReceived = 
# 403 "./src/main/rx/rx.c" 3 4
                              1
# 403 "./src/main/rx/rx.c"
                                  ;
            rxIsInFailsafeMode = 
# 404 "./src/main/rx/rx.c" 3 4
                                0
# 404 "./src/main/rx/rx.c"
                                     ;
        ...
        if (isPWMDataBeingReceived()) {
            rxSignalReceived = 
# 410 "./src/main/rx/rx.c" 3 4
                              1
# 410 "./src/main/rx/rx.c"
                                  ;
            rxIsInFailsafeMode = 
...
static void detectAndApplySignalLossBehaviour(void)
{
    ...
    const 
# 527 "./src/main/rx/rx.c" 3 4
         _Bool 
# 527 "./src/main/rx/rx.c"
...
# 535 "./src/main/rx/rx.c"
    ...
    for (int channel = 0; channel < rxChannelCount; channel++) {
        ...
        const 
# 539 "./src/main/rx/rx.c" 3 4
             _Bool 
# 539 "./src/main/rx/rx.c"
        ...
        if (validPulse) {
            ...
            if (cmp32(currentTimeMs, rcInvalidPulsPeriod[channel]) < 0) {
                ...
                if (channel < 4) {
                    rxFlightChannelsValid = 
# 549 "./src/main/rx/rx.c" 3 4
                                           0
# 549 "./src/main/rx/rx.c"
                                                ;
                }
            }
        }
    ...
    calculateRxChannelsAndUpdateFailsafe(timeUs_t currentTimeUs)
{
    ...
    if (!rxDataProcessingRequired) {
        return 
# 583 "./src/main/rx/rx.c" 3 4
              0
# 583 "./src/main/rx/rx.c"
                   ;
    }

    rxDataProcessingRequired = 
# 586 "./src/main/rx/rx.c" 3 4
                              0
# 586 "./src/main/rx/rx.c"
                                   ;
    ...
    if (skipRxSamples) {
        ...
        return 
# 595 "./src/main/rx/rx.c" 3 4
              1
# 595 "./src/main/rx/rx.c"
                  ;
    }
