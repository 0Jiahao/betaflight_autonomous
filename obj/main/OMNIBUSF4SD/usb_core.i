...
# 441 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
  return status;
}
...
# 467 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_DisableGlobalInt(USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_GAHBCFG_TypeDef ahbcfg;
...
# 484 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_FlushTxFifo (USB_OTG_CORE_HANDLE *pdev , uint32_t num )
{
  USB_OTG_STS status = USB_OTG_OK;
  volatile USB_OTG_GRSTCTL_TypeDef greset;
...
# 544 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 1213 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
void USB_OTG_InitDevSpeed(USB_OTG_CORE_HANDLE *pdev , uint8_t speed)
{
...
# 1229 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_CoreInitDev (USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
...
# 1341 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 1452 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
enum USB_OTG_SPEED USB_OTG_GetDeviceSpeed (USB_OTG_CORE_HANDLE *pdev)
{
...
# 1566 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 1751 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_EP0StartXfer(USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_DEPCTL_TypeDef depctl;
...
# 1936 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
uint32_t USB_OTG_ReadDevOutEP_itr(USB_OTG_CORE_HANDLE *pdev , uint8_t epnum)
{
  uint32_t v;
...
# 2084 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
uint32_t USB_OTG_GetEPStatus(USB_OTG_CORE_HANDLE *pdev ,USB_OTG_EP *ep)
{
  USB_OTG_DEPCTL_TypeDef depctl;
  volatile uint32_t *depctl_addr;
...
# 2138 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
void USB_OTG_SetEPStatus (USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep , uint32_t Status)
{
  USB_OTG_DEPCTL_TypeDef depctl;
  volatile uint32_t *depctl_addr;
