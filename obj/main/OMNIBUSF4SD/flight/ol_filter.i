...
# 2 "./src/main/flight/ol_filter.c" 2
...
# 4 "./src/main/flight/ol_filter.c" 2
...
# 6 "./src/main/flight/ol_filter.c" 2
...
# 7 "./src/main/flight/ol_filter.c" 2
...
# 8 "./src/main/flight/ol_filter.c" 2
...
# 9 "./src/main/flight/ol_filter.c" 2
...
# 11 "./src/main/flight/ol_filter.c" 2
...
void ol_filter_predict(void)
{
  ...
  float theta = -((attitude.values.pitch / 10.0f) * 0.0174532925f);
  float phi = ((attitude.values.roll / 10.0f) * 0.0174532925f);
  float psi = ((attitude.values.yaw / 10.0f) * 0.0174532925f);
  ...
  float abx = sinf(-theta) * 9.81 / cosf(theta * 0.8) / cosf(phi * 0.8);
  float aby = sinf( phi) * 9.81 / cosf(theta * 0.8) / cosf(phi * 0.8);


  float ax = cosf(psi) * abx - sinf(psi) * aby - dr_state.vx * 0.5 ;
  float ay = sinf(psi) * abx + cosf(psi) * aby - dr_state.vy * 0.5;
  ...
  {if (debugMode == (DEBUG_OL)) {debug[(0)] = (100 * dr_state.x);}};
  {if (debugMode == (DEBUG_OL)) {debug[(1)] = (100 * dr_state.y);}};
  {if (debugMode == (DEBUG_OL)) {debug[(2)] = (100 * dr_state.vx);}};
  {if (debugMode == (DEBUG_OL)) {debug[(3)] = (100 * dr_state.vy);}};
  {if (debugMode == (DEBUG_FP)) {debug[(0)] = (100 * dr_state.x);}};
  {if (debugMode == (DEBUG_FP)) {debug[(1)] = (100 * dr_state.y);}};
  {if (debugMode == (DEBUG_FP)) {debug[(2)] = (dr_control.theta_cmd/3.14*180);}};
  {if (debugMode == (DEBUG_FP)) {debug[(3)] = (dr_control.phi_cmd/3.14*180);}};
