           ...
           gyroInitSensor(gyroSensor_t *gyroSensor)
{
    ...
    gyroSensor->gyroDev.mpuIntExtiTag = ((ioTag_t)((((2) + 1) << 4) | (4)));
# 390 "./src/main/sensors/gyro.c"
...
static 
# 548 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 548 "./src/main/sensors/gyro.c"
...
# 741 "./src/main/sensors/gyro.c"
        ...
        if (overflowCheck & overflowAxisMask) {
            gyroSensor->overflowDetected = 
# 762 "./src/main/sensors/gyro.c" 3 4
                                          1
# 762 "./src/main/sensors/gyro.c"
                                              ;
            gyroSensor->overflowTimeUs = currentTimeUs;
        }
