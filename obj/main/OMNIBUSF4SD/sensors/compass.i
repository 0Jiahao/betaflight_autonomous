...
# 106 "./src/main/sensors/compass.c"
...
# 116 "./src/main/sensors/compass.c" 3 4
_Bool 
# 116 "./src/main/sensors/compass.c"
    compassDetect(magDev_t *dev)
{
    ...
    case BUSTYPE_SPI:
        ...
        break;
# 155 "./src/main/sensors/compass.c"
        break;

    default:
        return 
# 158 "./src/main/sensors/compass.c" 3 4
              0
# 158 "./src/main/sensors/compass.c"
    ...
    case MAG_AK8975:
# 197 "./src/main/sensors/compass.c"
        __attribute__ ((fallthrough));
...
# 218 "./src/main/sensors/compass.c"
    ...
    if (magHardware == MAG_NONE) {
        return 
# 226 "./src/main/sensors/compass.c" 3 4
              0
# 226 "./src/main/sensors/compass.c"
                   ;
    }
    ...
    return 
# 231 "./src/main/sensors/compass.c" 3 4
          1
...
# 249 "./src/main/sensors/compass.c"
    ...
    ledSet(1, 
# 255 "./src/main/sensors/compass.c" 3 4
   1
# 255 "./src/main/sensors/compass.c"
   );
    magDev.init(&magDev);
    ledSet(1, 
# 257 "./src/main/sensors/compass.c" 3 4
   0
# 257 "./src/main/sensors/compass.c"
   );
    magInit = 1;
