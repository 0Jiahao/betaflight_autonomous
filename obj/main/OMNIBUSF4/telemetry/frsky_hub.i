...
# 340 "./src/main/telemetry/frsky_hub.c"
...
# 371 "./src/main/telemetry/frsky_hub.c"
...
# 448 "./src/main/telemetry/frsky_hub.c" 3 4
_Bool 
# 448 "./src/main/telemetry/frsky_hub.c"
    initFrSkyHubTelemetry(void)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 460 "./src/main/telemetry/frsky_hub.c" 3 4
              1
# 460 "./src/main/telemetry/frsky_hub.c"
                  ;
    }

    return 
# 463 "./src/main/telemetry/frsky_hub.c" 3 4
          0
# 463 "./src/main/telemetry/frsky_hub.c"
               ;
}


# 466 "./src/main/telemetry/frsky_hub.c" 3 4
_Bool 
# 466 "./src/main/telemetry/frsky_hub.c"
    initFrSkyHubTelemetryExternal(frSkyHubWriteByteFn *frSkyHubWriteByteExternal)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 473 "./src/main/telemetry/frsky_hub.c" 3 4
              1
# 473 "./src/main/telemetry/frsky_hub.c"
                  ;
    }

    return 
# 476 "./src/main/telemetry/frsky_hub.c" 3 4
          0
# 476 "./src/main/telemetry/frsky_hub.c"
               ;
}
...
void freeFrSkyHubTelemetryPort(void)
{
    ...
    frSkyHubPort = 
# 482 "./src/main/telemetry/frsky_hub.c" 3 4
                  ((void *)0)
# 482 "./src/main/telemetry/frsky_hub.c"
                      ;
}
...
# 488 "./src/main/telemetry/frsky_hub.c" 3 4
                                                                                           ((void *)0)
# 488 "./src/main/telemetry/frsky_hub.c"
                                                                                               , 
# 488 "./src/main/telemetry/frsky_hub.c" 3 4
                                                                                                 ((void *)0)
# 488 "./src/main/telemetry/frsky_hub.c"
...
void checkFrSkyHubTelemetryState(void)
{
    if (telemetryState == TELEMETRY_STATE_INITIALIZED_SERIAL) {
        if (telemetryCheckRxPortShared(portConfig)) {
            if (frSkyHubPort == 
# 496 "./src/main/telemetry/frsky_hub.c" 3 4
                               ((void *)0) 
# 496 "./src/main/telemetry/frsky_hub.c"
                                    && telemetrySharedPort != 
# 496 "./src/main/telemetry/frsky_hub.c" 3 4
                                                              ((void *)0)
# 496 "./src/main/telemetry/frsky_hub.c"
...
# 500 "./src/main/telemetry/frsky_hub.c" 3 4
           _Bool 
# 500 "./src/main/telemetry/frsky_hub.c"
