...
# 501 "./src/main/target/system_stm32f4xx.c"
...
void SystemInitOC(void)
{
      ...
      const uint32_t overclockLevel = (*(volatile uint32_t *) 0x2001FFF4);
...
void OverclockRebootIfNecessary(uint32_t overclockLevel)
{
  ...
  if (SystemCoreClock != (pll->n / pll->p) * 1000000) {
    (*(volatile uint32_t *) 0x2001FFF8) = 0xBABEFACE;
    (*(volatile uint32_t *) 0x2001FFF4) = overclockLevel;
    __disable_irq();
    NVIC_SystemReset();
  }
}
# 609 "./src/main/target/system_stm32f4xx.c"
void SystemCoreClockUpdate(void)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      break;
# 669 "./src/main/target/system_stm32f4xx.c"
    default:
      SystemCoreClock = ((uint32_t)16000000);
      break;
  }
...
# 688 "./src/main/target/system_stm32f4xx.c"
void SetSysClock(void)
{
...
# 753 "./src/main/target/system_stm32f4xx.c"
...
# 779 "./src/main/target/system_stm32f4xx.c"
...
# 788 "./src/main/target/system_stm32f4xx.c"
...
# 838 "./src/main/target/system_stm32f4xx.c"
}
