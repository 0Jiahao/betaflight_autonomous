...
# 18 "./src/main/drivers/rangefinder/rangefinder_lidartf.h"
...
# 24 "./src/main/drivers/rangefinder/rangefinder_lidartf.h" 3 4
_Bool 
# 24 "./src/main/drivers/rangefinder/rangefinder_lidartf.h"
    lidarTFminiDetect(rangefinderDev_t *dev);

# 25 "./src/main/drivers/rangefinder/rangefinder_lidartf.h" 3 4
_Bool 
# 25 "./src/main/drivers/rangefinder/rangefinder_lidartf.h"
...
# 85 "./src/main/sensors/rangefinder.c"
...
static 
# 94 "./src/main/sensors/rangefinder.c" 3 4
      _Bool 
# 94 "./src/main/sensors/rangefinder.c"
...
# 172 "./src/main/sensors/rangefinder.c"
    ...
    return 
# 177 "./src/main/sensors/rangefinder.c" 3 4
          1
# 177 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 182 "./src/main/sensors/rangefinder.c" 3 4
                                     0
# 182 "./src/main/sensors/rangefinder.c"
                                          ;
...
# 189 "./src/main/sensors/rangefinder.c"
    ...
    return 
# 207 "./src/main/sensors/rangefinder.c" 3 4
          1
# 207 "./src/main/sensors/rangefinder.c"
              ;
}
...
static int32_t applyMedianFilter(int32_t newReading)
{
    ...
    static 
# 215 "./src/main/sensors/rangefinder.c" 3 4
          _Bool 
# 215 "./src/main/sensors/rangefinder.c"
               medianFilterReady = 
# 215 "./src/main/sensors/rangefinder.c" 3 4
                                   0
# 215 "./src/main/sensors/rangefinder.c"
    ...
    if (newReading > (-1)) {
        ...
        if (filterSampleIndex == 5) {
            filterSampleIndex = 0;
            medianFilterReady = 
# 222 "./src/main/sensors/rangefinder.c" 3 4
                               1
# 222 "./src/main/sensors/rangefinder.c"
                                   ;
        }
    }
...
static int16_t computePseudoSnr(int32_t newReading) {
    ...
    static 
# 233 "./src/main/sensors/rangefinder.c" 3 4
          _Bool 
# 233 "./src/main/sensors/rangefinder.c"
               snrReady = 
# 233 "./src/main/sensors/rangefinder.c" 3 4
                          0
# 233 "./src/main/sensors/rangefinder.c"
    ...
    if (snrSampleIndex == 5) {
        snrSampleIndex = 0;
        snrReady = 
# 240 "./src/main/sensors/rangefinder.c" 3 4
                  1
# 240 "./src/main/sensors/rangefinder.c"
                      ;
    }
...
# 272 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 272 "./src/main/sensors/rangefinder.c"
    ...
    if (
        ...
        if (rangefinder.snrThresholdReached) {
            ...
            return 
# 291 "./src/main/sensors/rangefinder.c" 3 4
                  1
# 291 "./src/main/sensors/rangefinder.c"
                      ;
        }
...
# 303 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 303 "./src/main/sensors/rangefinder.c"
    rangefinderProcess(float cosTiltAngle)
{
    if (rangefinder.dev.read) {
        ...
        if (distance == (-3)) {
            return 
# 310 "./src/main/sensors/rangefinder.c" 3 4
                  0
# 310 "./src/main/sensors/rangefinder.c"
                       ;
        }
        ...
        if (rangefinder.snrThresholdReached == 
# 328 "./src/main/sensors/rangefinder.c" 3 4
                                              0 
# 328 "./src/main/sensors/rangefinder.c"
                                                    && rangefinder.rawAltitude > 0) {
            ...
            if (rangefinder.snr >= 600) {
                rangefinder.snrThresholdReached = 
# 335 "./src/main/sensors/rangefinder.c" 3 4
                                                 1
# 335 "./src/main/sensors/rangefinder.c"
                                                     ;
            }
    ...
    return 
# 368 "./src/main/sensors/rangefinder.c" 3 4
          1
# 368 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 384 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 384 "./src/main/sensors/rangefinder.c"
    rangefinderIsHealthy(void)
{
