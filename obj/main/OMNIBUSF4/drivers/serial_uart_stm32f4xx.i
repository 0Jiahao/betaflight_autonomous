...
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_stm32f4xx.c"
# 22 "./src/main/drivers/serial_uart_stm32f4xx.c"
...
# 23 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 36 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 83 "./src/main/drivers/serial_uart_stm32f4xx.c"
    {
        .device = UARTDEV_3,
...
# 146 "./src/main/drivers/serial_uart_stm32f4xx.c"
    {
        .device = UARTDEV_6,
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    if (!uart) return 
# 200 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
                     ((void *)0)
# 200 "./src/main/drivers/serial_uart_stm32f4xx.c"
                         ;

    const uartHardware_t *hardware = uart->hardware;

    if (!hardware) return 
# 204 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
                         ((void *)0)
# 204 "./src/main/drivers/serial_uart_stm32f4xx.c"
                             ;
