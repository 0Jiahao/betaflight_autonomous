...
# 62 "./src/main/drivers/flash_m25p16.c"
static busDevice_t busInstance;
static busDevice_t *bus;
static 
# 64 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 64 "./src/main/drivers/flash_m25p16.c"
           isLargeFlash = 
# 64 "./src/main/drivers/flash_m25p16.c" 3 4
                          0
# 64 "./src/main/drivers/flash_m25p16.c"
                               ;
# 73 "./src/main/drivers/flash_m25p16.c"
...
static 
# 80 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 80 "./src/main/drivers/flash_m25p16.c"
           couldBeBusy = 
# 80 "./src/main/drivers/flash_m25p16.c" 3 4
                         0
# 80 "./src/main/drivers/flash_m25p16.c"
...
{
    m25p16_performOneByteCommand(bus, 0x06);


    couldBeBusy = 
# 123 "./src/main/drivers/flash_m25p16.c" 3 4
                 1
# 123 "./src/main/drivers/flash_m25p16.c"
                     ;
}
...
# 136 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 136 "./src/main/drivers/flash_m25p16.c"
    m25p16_isReady(void)
{

    couldBeBusy = couldBeBusy && ((m25p16_readStatus(bus) & 0x01) != 0);

    return !couldBeBusy;
}


# 144 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 144 "./src/main/drivers/flash_m25p16.c"
    m25p16_waitForReady(uint32_t timeoutMillis)
{
    ...
    while (!m25p16_isReady()) {
        if (millis() - time > timeoutMillis) {
            return 
# 149 "./src/main/drivers/flash_m25p16.c" 3 4
                  0
# 149 "./src/main/drivers/flash_m25p16.c"
                       ;
        }
    }

    return 
# 153 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 153 "./src/main/drivers/flash_m25p16.c"
              ;
}
...
# 215 "./src/main/drivers/flash_m25p16.c"
    ...
    if (geometry.totalSize > 16 * 1024 * 1024) {
        isLargeFlash = 
# 222 "./src/main/drivers/flash_m25p16.c" 3 4
                      1
# 222 "./src/main/drivers/flash_m25p16.c"
                          ;
        m25p16_performOneByteCommand(bus, 0xB7);
    }
...
# 226 "./src/main/drivers/flash_m25p16.c"
    ...
    return 
# 228 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 228 "./src/main/drivers/flash_m25p16.c"
              ;
}
    ...
    m25p16_init(const flashConfig_t *flashConfig)
{
    ...
    if (geometry.sectors) {
        return 
# 244 "./src/main/drivers/flash_m25p16.c" 3 4
              1
# 244 "./src/main/drivers/flash_m25p16.c"
                  ;
    }
    ...
    if (flashConfig->csTag) {
        ...
        return 
# 253 "./src/main/drivers/flash_m25p16.c" 3 4
              0
# 253 "./src/main/drivers/flash_m25p16.c"
                   ;
    }
...
void m25p16_eraseCompletely(void)
{
    ...
    m25p16_performOneByteCommand(bus, 0xC7);
}
...
# 323 "./src/main/drivers/flash_m25p16.c" 3 4
                                                    ((void *)0)
# 323 "./src/main/drivers/flash_m25p16.c"
                                                        , isLargeFlash ? 5 : 4);

    spiTransfer(bus->busdev_u.spi.instance, data, 
# 325 "./src/main/drivers/flash_m25p16.c" 3 4
                                                 ((void *)0)
...
# 351 "./src/main/drivers/flash_m25p16.c"
void m25p16_pageProgram(uint32_t address, const uint8_t *data, int length)
{
...
# 368 "./src/main/drivers/flash_m25p16.c"
int m25p16_readBytes(uint32_t address, uint8_t *buffer, int length)
{
    ...
    spiTransfer(bus->busdev_u.spi.instance, command, 
# 380 "./src/main/drivers/flash_m25p16.c" 3 4
                                                    ((void *)0)
# 380 "./src/main/drivers/flash_m25p16.c"
                                                        , isLargeFlash ? 5 : 4);
    spiTransfer(bus->busdev_u.spi.instance, 
# 381 "./src/main/drivers/flash_m25p16.c" 3 4
                                           ((void *)0)
# 381 "./src/main/drivers/flash_m25p16.c"
                                               , buffer, length);
