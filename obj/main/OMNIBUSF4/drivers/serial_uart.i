...
void uartTryStartTxDMA(uartPort_t *s)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        ...
        if (s->port.txBufferHead == s->port.txBufferTail) {
            ...
            s->txDMAEmpty = 
# 82 "./src/main/drivers/serial_uart.c" 3 4
                           1
# 82 "./src/main/drivers/serial_uart.c"
                               ;
            return;
        }
        ...
        s->txDMAEmpty = 
# 98 "./src/main/drivers/serial_uart.c" 3 4
                       0
# 98 "./src/main/drivers/serial_uart.c"
                            ;

    reenable:
        DMA_Cmd(s->txDMAStream, ENABLE);
# 138 "./src/main/drivers/serial_uart.c"
    }
}
...
# 330 "./src/main/drivers/serial_uart.c"
