...
# 46 "./src/main/drivers/compass/compass_hmc5883l.c" 2
# 156 "./src/main/drivers/compass/compass_hmc5883l.c"
static void hmc5883lConfigureDataReadyInterruptHandling(magDev_t* mag)
{
# 185 "./src/main/drivers/compass/compass_hmc5883l.c"
    (void)(mag);
...
# 203 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
                       (-0x7fff - 1)
# 203 "./src/main/drivers/compass/compass_hmc5883l.c"
                                , 
# 203 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
                                  (0x7fff)
# 203 "./src/main/drivers/compass/compass_hmc5883l.c"
...
static 
# 206 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 206 "./src/main/drivers/compass/compass_hmc5883l.c"
...
# 212 "./src/main/drivers/compass/compass_hmc5883l.c"
    ...
    if (!ack) {
        return 
# 215 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
              0
# 215 "./src/main/drivers/compass/compass_hmc5883l.c"
                   ;
    }
...
static 
# 227 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 227 "./src/main/drivers/compass/compass_hmc5883l.c"
...
# 239 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
   _Bool 
# 239 "./src/main/drivers/compass/compass_hmc5883l.c"
        bret = 
# 239 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
               1
# 239 "./src/main/drivers/compass/compass_hmc5883l.c"
    ...
    busWriteRegister(busdev, 0x00, 0X10 | 0x01);




    busWriteRegister(busdev, 0x01, 0X60);
    ...
    for (int polarity = polPos; polarity <= polNeg; polarity++) {
        ...
        case polPos:
            ...
            break;
        case polNeg:
            busWriteRegister(busdev, 0x00, 0X10 | 0x02);
            break;
        }
        for (i = 0; i < 10; i++) {
            busWriteRegister(busdev, 0x02, 0X01);
            delay(20);
            hmc5883lRead(mag, magADC);
            ...
            if (-4096 >= __extension__ ({ __typeof__ (magADC[X]) _a = (magADC[X]); __typeof__ (__extension__ ({ __typeof__ (magADC[Y]) _a = (magADC[Y]); __typeof__ (magADC[Z]) _b = (magADC[Z]); _a < _b ? _a : _b; })) _b = (__extension__ ({ __typeof__ (magADC[Y]) _a = (magADC[Y]); __typeof__ (magADC[Z]) _b = (magADC[Z]); _a < _b ? _a : _b; })); _a < _b ? _a : _b; })) {
                bret = 
# 280 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
                      0
# 280 "./src/main/drivers/compass/compass_hmc5883l.c"
                           ;
                break;
            }
            ledToggle(1);
    ...
    mag->magGain[X] = (int)(660.0f * (+1.16f) * 2.0f * 10.0f * 256.0f) / xyz_total[X];
    mag->magGain[Y] = (int)(660.0f * (+1.16f) * 2.0f * 10.0f * 256.0f) / xyz_total[Y];
    mag->magGain[Z] = (int)(660.0f * (+1.08f) * 2.0f * 10.0f * 256.0f) / xyz_total[Z];
    ...
    return 
# 306 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 306 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}


# 309 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
_Bool 
# 309 "./src/main/drivers/compass/compass_hmc5883l.c"
    hmc5883lDetect(magDev_t* mag)
{
    busDevice_t *busdev = &mag->busdev;

    uint8_t sig = 0;
# 322 "./src/main/drivers/compass/compass_hmc5883l.c"
...
# 327 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
   _Bool 
# 327 "./src/main/drivers/compass/compass_hmc5883l.c"
        ack = busReadRegisterBuffer(&mag->busdev, 0x0A, &sig, 1);

    if (!ack || sig != 0x48) {
        return 
# 330 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
              0
# 330 "./src/main/drivers/compass/compass_hmc5883l.c"
                   ;
    }
    ...
    return 
# 336 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 336 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}
