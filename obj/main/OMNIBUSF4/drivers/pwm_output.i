...
# 51 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 51 "./src/main/drivers/pwm_output.c"
    useBurstDshot = 
# 51 "./src/main/drivers/pwm_output.c" 3 4
                    0
# 51 "./src/main/drivers/pwm_output.c"
...
{
# 72 "./src/main/drivers/pwm_output.c"
...
void pwmDisableMotors(void)
{
    ...
    pwmMotorsEnabled = 
# 182 "./src/main/drivers/pwm_output.c" 3 4
                      0
# 182 "./src/main/drivers/pwm_output.c"
                           ;
}
...
# 248 "./src/main/drivers/pwm_output.c"
    ...
    case PWM_TYPE_PROSHOT1000:
        ...
        isDshot = 
# 256 "./src/main/drivers/pwm_output.c" 3 4
                 1
# 256 "./src/main/drivers/pwm_output.c"
                     ;
        break;
...
# 265 "./src/main/drivers/pwm_output.c"
        ...
        if (motorConfig->useBurstDshot) {
            useBurstDshot = 
# 268 "./src/main/drivers/pwm_output.c" 3 4
                           1
# 268 "./src/main/drivers/pwm_output.c"
                               ;
        }
    ...
    for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
        ...
        if (timerHardware == 
# 284 "./src/main/drivers/pwm_output.c" 3 4
                            ((void *)0)
# 284 "./src/main/drivers/pwm_output.c"
                                ) {
...
# 328 "./src/main/drivers/pwm_output.c" 3 4
       _Bool 
# 328 "./src/main/drivers/pwm_output.c"
            timerAlreadyUsed = 
# 328 "./src/main/drivers/pwm_output.c" 3 4
                               0
# 328 "./src/main/drivers/pwm_output.c"
        ...
        for (int i = 0; i < motorIndex; i++) {
            if (motors[i].channel.tim == motors[motorIndex].channel.tim) {
                timerAlreadyUsed = 
# 331 "./src/main/drivers/pwm_output.c" 3 4
                                  1
# 331 "./src/main/drivers/pwm_output.c"
                                      ;
                break;
            }
        }
...
# 336 "./src/main/drivers/pwm_output.c"
    ...
    pwmMotorsEnabled = 
# 339 "./src/main/drivers/pwm_output.c" 3 4
                      1
# 339 "./src/main/drivers/pwm_output.c"
                          ;
}
...
# 347 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 347 "./src/main/drivers/pwm_output.c"
    isMotorProtocolDshot(void)
{
    return isDshot;
}
...
uint16_t prepareDshotPacket(motorDmaOutput_t *const motor, const uint16_t value)
{
    ...
    motor->requestTelemetry = 
# 407 "./src/main/drivers/pwm_output.c" 3 4
                             0
# 407 "./src/main/drivers/pwm_output.c"
                                  ;
...
void servoDevInit(const servoDevConfig_t *servoConfig)
{
    for (uint8_t servoIndex = 0; servoIndex < 8; servoIndex++) {
        ...
        if (timer == 
# 452 "./src/main/drivers/pwm_output.c" 3 4
                    ((void *)0)
# 452 "./src/main/drivers/pwm_output.c"
                        ) {
...
# 457 "./src/main/drivers/pwm_output.c" 3 4
                                    1
# 457 "./src/main/drivers/pwm_output.c"
                                        ;
    }
}
                        ...
                        onoffBeep)
{
        if (!beeperPwm.io)
            return;
        if (onoffBeep == 
# 468 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 468 "./src/main/drivers/pwm_output.c"
                            ) {
            *beeperPwm.channel.ccr = (((1) * 1000000) / freqBeep) / 2;
            beeperPwm.enabled = 
# 470 "./src/main/drivers/pwm_output.c" 3 4
                               1
# 470 "./src/main/drivers/pwm_output.c"
                                   ;
        } else {
            *beeperPwm.channel.ccr = 0;
            beeperPwm.enabled = 
# 473 "./src/main/drivers/pwm_output.c" 3 4
                               0
# 473 "./src/main/drivers/pwm_output.c"
                                    ;
        }
}
...
void beeperPwmInit(const ioTag_t tag, uint16_t frequency)
{
        ...
        *beeperPwm.channel.ccr = 0;
        beeperPwm.enabled = 
# 497 "./src/main/drivers/pwm_output.c" 3 4
                           0
# 497 "./src/main/drivers/pwm_output.c"
                                ;
}
