...
# 27 "./src/main/drivers/transponder_ir.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 28 "./src/main/drivers/transponder_ir.c" 2
...
# 29 "./src/main/drivers/transponder_ir.c" 2
...
# 30 "./src/main/drivers/transponder_ir.c" 2
...
# 31 "./src/main/drivers/transponder_ir.c" 2
...
# 33 "./src/main/drivers/transponder_ir.c" 2
# 1 "./src/main/drivers/transponder_ir_arcitimer.h" 1
# 17 "./src/main/drivers/transponder_ir_arcitimer.h"
       
# 33 "./src/main/drivers/transponder_ir_arcitimer.h"
...
# 34 "./src/main/drivers/transponder_ir.c" 2
...
# 35 "./src/main/drivers/transponder_ir.c" 2
...
# 36 "./src/main/drivers/transponder_ir.c" 2
...
# 41 "./src/main/drivers/transponder_ir.c" 3 4
                           ((void *)0)
# 41 "./src/main/drivers/transponder_ir.c"
                               ;



static DMA_Stream_TypeDef *dmaRef = 
# 45 "./src/main/drivers/transponder_ir.c" 3 4
                                   ((void *)0)
# 45 "./src/main/drivers/transponder_ir.c"
                                       ;
...
# 75 "./src/main/drivers/transponder_ir.c" 3 4
                                ((void *)0)
# 75 "./src/main/drivers/transponder_ir.c"
                                    ) {
        return;
    }
...
# 155 "./src/main/drivers/transponder_ir.c" 3 4
_Bool 
# 155 "./src/main/drivers/transponder_ir.c"
    transponderIrInit(const ioTag_t ioTag, const transponderProvider_e provider)
{
    if (!ioTag) {
        return 
# 158 "./src/main/drivers/transponder_ir.c" 3 4
              0
# 158 "./src/main/drivers/transponder_ir.c"
                   ;
    }
    ...
    switch (provider) {
        ...
        default:
            return 
# 172 "./src/main/drivers/transponder_ir.c" 3 4
                  0
# 172 "./src/main/drivers/transponder_ir.c"
                       ;
    }
    ...
    return 
# 177 "./src/main/drivers/transponder_ir.c" 3 4
          1
# 177 "./src/main/drivers/transponder_ir.c"
              ;
}


# 180 "./src/main/drivers/transponder_ir.c" 3 4
_Bool 
# 180 "./src/main/drivers/transponder_ir.c"
    isTransponderIrReady(void)
{
