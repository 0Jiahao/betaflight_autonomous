...
# 40 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
_Bool 
# 40 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    mpu6500AccDetect(accDev_t *acc)
{
...
void mpu6500GyroInit(gyroDev_t *gyro)
{
    ...
    busWriteRegister(&gyro->bus, 0x1B, raGyroConfigData);
    delay(15);
    busWriteRegister(&gyro->bus, 0x1C, INV_FSR_16G << 3);
    delay(15);
    busWriteRegister(&gyro->bus, 0x1A, gyro->lpf);
    delay(15);
...
# 88 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
_Bool 
# 88 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    mpu6500GyroDetect(gyroDev_t *gyro)
{
    if (gyro->mpuDetectionResult.sensor != MPU_65xx_I2C) {
        return 
# 91 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
              0
# 91 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                   ;
    }
