...
# 24 "./src/main/drivers/system_stm32f4xx.c" 2

# 1 "./src/main/drivers/nvic.h" 1

       
# 26 "./src/main/drivers/system_stm32f4xx.c" 2
...
# 153 "./src/main/drivers/system_stm32f4xx.c" 3 4
_Bool 
# 153 "./src/main/drivers/system_stm32f4xx.c"
    isMPUSoftReset(void)
{
    if (cachedRccCsrValue & ((uint32_t)0x10000000))
        return 
# 156 "./src/main/drivers/system_stm32f4xx.c" 3 4
              1
# 156 "./src/main/drivers/system_stm32f4xx.c"
                  ;
    else
        return 
# 158 "./src/main/drivers/system_stm32f4xx.c" 3 4
              0
# 158 "./src/main/drivers/system_stm32f4xx.c"
                   ;
}
