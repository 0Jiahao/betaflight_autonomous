...
# 162 "./src/main/drivers/serial_uart_init.c"
...
# 184 "./src/main/drivers/serial_uart_init.c"
        } else {
    ...
    if (mode & MODE_TX) {
        ...
        if (s->txDMAStream) {
            ...
            DMA_InitStructure.DMA_MemoryBurst = ((uint32_t)0x00000000) ;
            DMA_InitStructure.DMA_PeripheralBurst = ((uint32_t)0x00000000);
# 216 "./src/main/drivers/serial_uart_init.c"
...
# 235 "./src/main/drivers/serial_uart_init.c"
