...
# 26 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 27 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 31 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 33 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 53 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
...
# 95 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
...
# 150 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
_Bool 
# 150 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
    hcsr04Detect(rangefinderDev_t *dev, const sonarConfig_t * rangefinderHardwarePins)
{
    
# 152 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
   _Bool 
# 152 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
        detected = 
# 152 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                   0
# 152 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
    ...
    if (IOGetOwner(triggerIO) != OWNER_FREE) {
        return 
# 167 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              0
# 167 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                   ;
    }

    if (IOGetOwner(echoIO) != OWNER_FREE) {
        return 
# 171 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              0
# 171 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                   ;
    }
    ...
    if (IORead(echoIO) == 
# 185 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                         0
# 185 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                              ) {
        for (int i = 0; i < 5 && !detected; i++) {
            ...
            while ((millis() - requestTime) < 60) {
                if (IORead(echoIO) == 
# 191 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                                     1
# 191 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                                         ) {
                    detected = 
# 192 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                              1
# 192 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                                  ;
                    break;
                }
            }
    ...
    if (detected) {
        ...
        EXTIEnable(echoIO, 
# 204 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                          1
# 204 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                              );
        ...
        return 
# 216 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              1
# 216 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                  ;
    }
    else {
        ...
        IORelease(echoIO);
        return 
# 222 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              0
# 222 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                   ;
    }
}
