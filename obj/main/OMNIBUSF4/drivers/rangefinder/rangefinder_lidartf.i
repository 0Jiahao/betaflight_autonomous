...
# 26 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 27 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
...
# 31 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
...
# 33 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
...
# 91 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
static serialPort_t *tfSerialPort = 
# 91 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
                                   ((void *)0)
# 91 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                                       ;
...
void lidarTFUpdate(rangefinderDev_t *dev)
{
    ...
    if (tfSerialPort == 
# 142 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
                       ((void *)0)
# 142 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                           ) {
        return;
    }
...
static 
# 234 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
      _Bool 
# 234 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
           lidarTFDetect(rangefinderDev_t *dev, uint8_t devtype)
{
    ...
    if (!portConfig) {
        return 
# 239 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
              0
# 239 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                   ;
    }
...
# 242 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
    ...
    if (tfSerialPort == 
# 244 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
                       ((void *)0)
# 244 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                           ) {
        return 
# 245 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
              0
# 245 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                   ;
    }
    ...
    return 
# 259 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
          1
# 259 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
              ;
}


# 262 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
_Bool 
# 262 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
    lidarTFminiDetect(rangefinderDev_t *dev)
{
