...
static 
# 118 "./src/main/io/vtx.c" 3 4
      _Bool 
# 118 "./src/main/io/vtx.c"
    ...
    if(!(armingFlags & (ARMED))) {
        ...
        if (vtxCommonGetBandAndChannel(vtxDevice, &vtxBand, &vtxChan)) {
            ...
            if (vtxBand != settings.band || vtxChan != settings.channel) {
                ...
                return 
# 127 "./src/main/io/vtx.c" 3 4
                      1
# 127 "./src/main/io/vtx.c"
                          ;
            }
        }
    }
    ...
    if(!(armingFlags & (ARMED))) {
        ...
        if (vtxCommonGetFrequency(vtxDevice, &vtxFreq)) {
            ...
            if (vtxFreq != settings.freq) {
                ...
                return 
# 143 "./src/main/io/vtx.c" 3 4
                      1
# 143 "./src/main/io/vtx.c"
                          ;
            }
        }
    }
...
# 221 "./src/main/io/vtx.c" 3 4
       _Bool 
# 221 "./src/main/io/vtx.c"
            vtxUpdatePending = 
# 221 "./src/main/io/vtx.c" 3 4
                               0
# 221 "./src/main/io/vtx.c"
