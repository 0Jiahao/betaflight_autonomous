...
# 49 "./src/main/io/vtx_control.c" 3 4
1 
# 49 "./src/main/io/vtx_control.c"
}
...
void vtxCycleBandOrChannel(const uint8_t bandStep, const uint8_t channelStep)
{
    ...
    if (vtxDevice) {
        ...
        const 
# 134 "./src/main/io/vtx_control.c" 3 4
             _Bool 
# 134 "./src/main/io/vtx_control.c"
...
void vtxCyclePower(const uint8_t powerStep)
{
    ...
    if (vtxDevice) {
        ...
        vtxDeviceCapability_t capability;
        const 
# 164 "./src/main/io/vtx_control.c" 3 4
             _Bool 
# 164 "./src/main/io/vtx_control.c"
...
# 196 "./src/main/io/vtx_control.c"
void handleVTXControlButton(void)
{
# 269 "./src/main/io/vtx_control.c"
}
