...
static void vtxTrampProcess(vtxDevice_t *vtxDevice, timeUs_t currentTimeUs)
{
    ...
    static 
# 374 "./src/main/io/vtx_tramp.c" 3 4
          _Bool 
# 374 "./src/main/io/vtx_tramp.c"
    ...
    case 'r':
        if (trampStatus <= TRAMP_STATUS_OFFLINE) {
            ...
            if (!initSettingsDoneFlag) {
                initSettingsDoneFlag = 
# 398 "./src/main/io/vtx_tramp.c" 3 4
                                      1
# 398 "./src/main/io/vtx_tramp.c"
                                          ;
...
# 434 "./src/main/io/vtx_tramp.c" 3 4
           _Bool 
# 434 "./src/main/io/vtx_tramp.c"
                done = 
# 434 "./src/main/io/vtx_tramp.c" 3 4
                       1
# 434 "./src/main/io/vtx_tramp.c"
...
# 441 "./src/main/io/vtx_tramp.c" 3 4
                      0
# 441 "./src/main/io/vtx_tramp.c"
                           ;
...
# 448 "./src/main/io/vtx_tramp.c" 3 4
                      0
# 448 "./src/main/io/vtx_tramp.c"
                           ;
            }
...
static 
# 500 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 500 "./src/main/io/vtx_tramp.c"
           vtxTrampIsReady(const vtxDevice_t *vtxDevice)
{
    return vtxDevice!=
# 502 "./src/main/io/vtx_tramp.c" 3 4
                     ((void *)0) 
# 502 "./src/main/io/vtx_tramp.c"
...
# 538 "./src/main/io/vtx_tramp.c"
    ...
    *pChannel = trampChannel;
    return 
# 544 "./src/main/io/vtx_tramp.c" 3 4
          1
# 544 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 568 "./src/main/io/vtx_tramp.c"
    ...
    *pOnOff = trampPitMode;
    return 
# 572 "./src/main/io/vtx_tramp.c" 3 4
          1
# 572 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 578 "./src/main/io/vtx_tramp.c"
    ...
    *pFreq = trampCurFreq;
    return 
# 582 "./src/main/io/vtx_tramp.c" 3 4
          1
# 582 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 601 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 601 "./src/main/io/vtx_tramp.c"
    vtxTrampInit(void)
{
...
# 613 "./src/main/io/vtx_tramp.c" 3 4
                                                                                    ((void *)0)
# 613 "./src/main/io/vtx_tramp.c"
                                                                                        , 
# 613 "./src/main/io/vtx_tramp.c" 3 4
                                                                                          ((void *)0)
# 613 "./src/main/io/vtx_tramp.c"
...
# 617 "./src/main/io/vtx_tramp.c"
    ...
    return 
# 624 "./src/main/io/vtx_tramp.c" 3 4
          1
# 624 "./src/main/io/vtx_tramp.c"
              ;
}
