...
# 8 "/home/jiahao/betaflight_autonomous/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/machine/_types.h" 2 3
...
# 13 "/home/jiahao/betaflight_autonomous/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/stdint.h" 3 4
...
# 269 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 269 "./src/main/io/ledstrip.c"
    parseLedStripConfig(int ledIndex, const char *config)
{
    if (ledIndex >= 32)
        return 
# 272 "./src/main/io/ledstrip.c" 3 4
              0
# 272 "./src/main/io/ledstrip.c"
                   ;
    ...
    for (enum parseState_e parseState = 0; parseState < PARSE_STATE_COUNT; parseState++) {
        char chunk[11];
        {
            ...
            if (*config != chunkSeparator) {
                return 
# 302 "./src/main/io/ledstrip.c" 3 4
                      0
# 302 "./src/main/io/ledstrip.c"
                           ;
            }
            config++;
        }
    ...
    *ledConfig = (((((((x) & 0x0F) << 4) | (((y) & 0x0F) << 0))) << 0) | ((color) << 18) | ((direction_flags) << 22) | ((baseFunction) << 8) | ((overlay_flags) << 12) | ((0) << 28));
    ...
    return 
# 353 "./src/main/io/ledstrip.c" 3 4
          1
# 353 "./src/main/io/ledstrip.c"
              ;
}
...
static hsvColor_t* getDirectionalModeColor(const int ledIndex, const modeColorIndexes_t *modeColors)
{
    ...
    return 
# 424 "./src/main/io/ledstrip.c" 3 4
          ((void *)0)
# 424 "./src/main/io/ledstrip.c"
              ;
}
...
# 530 "./src/main/io/ledstrip.c" 3 4
                                _Bool 
# 530 "./src/main/io/ledstrip.c"
...
# 552 "./src/main/io/ledstrip.c" 3 4
                                    ((void *)0)
# 552 "./src/main/io/ledstrip.c"
                                        ;
...
# 583 "./src/main/io/ledstrip.c" 3 4
                            _Bool 
# 583 "./src/main/io/ledstrip.c"
                                 updateNow, timeUs_t *timer)
{
...
# 588 "./src/main/io/ledstrip.c" 3 4
                                 0
# 588 "./src/main/io/ledstrip.c"
                                      ;
...
{
    static 
# 678 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 678 "./src/main/io/ledstrip.c"
               flash = 
# 678 "./src/main/io/ledstrip.c" 3 4
                       0
# 678 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
        ...
        switch (getBatteryState()) {
            case BATTERY_OK:
                flash = 
# 686 "./src/main/io/ledstrip.c" 3 4
                       1
# 686 "./src/main/io/ledstrip.c"
                           ;
...
# 713 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
        ...
        if (state > 50) {
            flash = 
# 721 "./src/main/io/ledstrip.c" 3 4
                   1
# 721 "./src/main/io/ledstrip.c"
                       ;
...
# 741 "./src/main/io/ledstrip.c" 3 4
                            _Bool 
# 741 "./src/main/io/ledstrip.c"
                                 updateNow, timeUs_t *timer)
{
...
# 766 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 766 "./src/main/io/ledstrip.c"
...
{
    static 
# 783 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 783 "./src/main/io/ledstrip.c"
               flash = 0;
...
# 844 "./src/main/io/ledstrip.c" 3 4
                                   _Bool 
# 844 "./src/main/io/ledstrip.c"
                                        updateNow, timeUs_t *timer)
{
...
# 859 "./src/main/io/ledstrip.c" 3 4
           _Bool 
# 859 "./src/main/io/ledstrip.c"
                applyColor;
...
# 914 "./src/main/io/ledstrip.c" 3 4
                                   _Bool 
# 914 "./src/main/io/ledstrip.c"
                                        updateNow, timeUs_t *timer)
{
...
# 939 "./src/main/io/ledstrip.c" 3 4
                              _Bool 
# 939 "./src/main/io/ledstrip.c"
                                   updateNow, timeUs_t *timer)
{
...
# 952 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 952 "./src/main/io/ledstrip.c"
        ledOn = (blinkMask & 1);
    if (!ledOn) {
...
# 1017 "./src/main/io/ledstrip.c"
           requiredTimerLayer[timTimerCount];
...
# 1045 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1045 "./src/main/io/ledstrip.c"
    isOverlayTypeUsed(ledOverlayId_e overlayType)
{
    for (int ledIndex = 0; ledIndex < ledCounts.count; ledIndex++) {
        ...
        if (ledGetOverlayBit(ledConfig, overlayType)) {
            return 
# 1050 "./src/main/io/ledstrip.c" 3 4
                  1
# 1050 "./src/main/io/ledstrip.c"
                      ;
        }
    }
    return 
# 1053 "./src/main/io/ledstrip.c" 3 4
          0
# 1053 "./src/main/io/ledstrip.c"
               ;
}
...
void updateRequiredOverlay(void)
{
    for (int timID = 0; timID < timTimerCount; timID++) {
        requiredTimerLayer[timID] = 
# 1059 "./src/main/io/ledstrip.c" 3 4
                                   1
# 1059 "./src/main/io/ledstrip.c"
                                       ;
    }
...
void ledStripUpdate(timeUs_t currentTimeUs)
{
    ...
    if (IS_RC_MODE_ACTIVE(BOXLEDLOW) && !(ledStripConfig()->ledstrip_visual_beeper && isBeeperOn())) {
        if (ledStripEnabled) {
            ledStripDisable();
            ledStripEnabled = 
# 1079 "./src/main/io/ledstrip.c" 3 4
                             0
# 1079 "./src/main/io/ledstrip.c"
                                  ;
        }
        return;
    }
...
# 1115 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 1115 "./src/main/io/ledstrip.c"
...
# 1121 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1121 "./src/main/io/ledstrip.c"
    parseColor(int index, const char *colorConfig)
{
...
# 1127 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 1127 "./src/main/io/ledstrip.c"
        result = 
# 1127 "./src/main/io/ledstrip.c" 3 4
                 1
# 1127 "./src/main/io/ledstrip.c"
    ...
    for (int componentIndex = 0; result && componentIndex < (HSV_VALUE + 1); componentIndex++) {
        ...
        if (val > hsv_limit[componentIndex]) {
            result = 
# 1136 "./src/main/io/ledstrip.c" 3 4
                    0
# 1136 "./src/main/io/ledstrip.c"
                         ;
            break;
        }
...
# 1170 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1170 "./src/main/io/ledstrip.c"
    setModeColor(ledModeIndex_e modeIndex, int modeColorIndex, int colorIndex)
{
...
# 1174 "./src/main/io/ledstrip.c"
    ...
    if (modeIndex < 6) {
        if (modeColorIndex < 0 || modeColorIndex >= 6)
            return 
# 1177 "./src/main/io/ledstrip.c" 3 4
                  0
# 1177 "./src/main/io/ledstrip.c"
                       ;
        ...
        if (modeColorIndex < 0 || modeColorIndex >= 11)
            return 
# 1181 "./src/main/io/ledstrip.c" 3 4
                  0
# 1181 "./src/main/io/ledstrip.c"
                       ;
        ...
        if (modeColorIndex < 0 || modeColorIndex >= 1)
            return 
# 1185 "./src/main/io/ledstrip.c" 3 4
                  0
# 1185 "./src/main/io/ledstrip.c"
                       ;
        ledStripConfigMutable()->ledstrip_aux_channel = colorIndex;
    } else {
        return 
# 1188 "./src/main/io/ledstrip.c" 3 4
              0
# 1188 "./src/main/io/ledstrip.c"
                   ;
    }
    return 
# 1190 "./src/main/io/ledstrip.c" 3 4
          1
# 1190 "./src/main/io/ledstrip.c"
              ;
}
...
void ledStripInit(void)
{
    ...
    ledStripInitialised = 
# 1198 "./src/main/io/ledstrip.c" 3 4
                         0
# 1198 "./src/main/io/ledstrip.c"
                              ;
}
...
void ledStripEnable(void)
{
    reevaluateLedConfig();
    ledStripInitialised = 
# 1204 "./src/main/io/ledstrip.c" 3 4
                         1
# 1204 "./src/main/io/ledstrip.c"
                             ;
