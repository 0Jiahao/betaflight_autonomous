...
const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .p_denom = 32, .device = BLACKBOX_DEVICE_FLASH, .record_acc = 1, .mode = BLACKBOX_MODE_NORMAL }
...
# 1192 "./src/main/blackbox/blackbox.c"
    ...
    switch (xmitState.headerIndex) {
        ...
        case 1: blackboxPrintfHeaderLine("Firmware revision", "%s %s (%s) %s", "Betaflight", "3" "." "3" "." "1", shortGitRevision, targetName); break;;
