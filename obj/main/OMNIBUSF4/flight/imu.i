...
static void imuCalculateAcceleration(timeDelta_t deltaT)
{
    ...
    my_dt = (int)((float)deltaT * 1e-3f);
    {if (debugMode == (DEBUG_DT)) {debug[(0)] = (my_dt);}};
...
# 265 "./src/main/flight/imu.c" 3 4
                               _Bool 
# 265 "./src/main/flight/imu.c"
                                    useMag, float mx, float my, float mz,
                                
# 266 "./src/main/flight/imu.c" 3 4
                               _Bool 
# 266 "./src/main/flight/imu.c"
...
static 
# 407 "./src/main/flight/imu.c" 3 4
      _Bool 
# 407 "./src/main/flight/imu.c"
...
# 427 "./src/main/flight/imu.c" 3 4
   _Bool 
# 427 "./src/main/flight/imu.c"
        useYaw = 
# 427 "./src/main/flight/imu.c" 3 4
                 0
# 427 "./src/main/flight/imu.c"
    ...
    if (imuIsAccelerometerHealthy()) {
        useAcc = 
# 433 "./src/main/flight/imu.c" 3 4
                1
# 433 "./src/main/flight/imu.c"
                    ;
    }
    ...
    if (sensors(SENSOR_MAG) && compassIsHealthy()) {
        useMag = 
# 438 "./src/main/flight/imu.c" 3 4
                1
# 438 "./src/main/flight/imu.c"
                    ;
    }


    if (!useMag && (stateFlags & (FIXED_WING)) && sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX)) && gpsSol.numSat >= 5 && gpsSol.groundSpeed >= 300) {

        rawYawError = ((attitude.values.yaw - gpsSol.groundCourse / 10.0f) * 0.0174532925f);
        useYaw = 
# 445 "./src/main/flight/imu.c" 3 4
                1
...
# 579 "./src/main/flight/imu.c" 3 4
_Bool 
# 579 "./src/main/flight/imu.c"
    imuQuaternionHeadfreeOffsetSet(void)
{
    if ((__extension__ ({ __typeof__ (attitude.values.roll) _x = (attitude.values.roll); _x > 0 ? _x : -_x; }) < 450) && (__extension__ ({ __typeof__ (attitude.values.pitch) _x = (attitude.values.pitch); _x > 0 ? _x : -_x; }) < 450)) {
        ...
        return 
# 589 "./src/main/flight/imu.c" 3 4
              1
# 589 "./src/main/flight/imu.c"
                  ;
    } else {
        return 
# 591 "./src/main/flight/imu.c" 3 4
              0
# 591 "./src/main/flight/imu.c"
                   ;
    }
}
