...
static float pidLevel(int axis, const pidProfile_t *pidProfile, const rollAndPitchTrims_t *angleTrim, float currentPidSetpoint) {
    ...
    if((flightModeFlags & (RANGEFINDER_MODE)))
    {
        ...
        {if (debugMode == (DEBUG_OLCTRL)) {debug[(1)] = (dr_control.theta_cmd/3.14*180);}};
        {if (debugMode == (DEBUG_OLCTRL)) {debug[(2)] = (dr_control.phi_cmd/3.14*180);}};
        {if (debugMode == (DEBUG_OLCTRL)) {debug[(3)] = (dr_control.psi_cmd/3.14*180);}};
    }
    {if (debugMode == (DEBUG_DESIREDANGLE)) {debug[(axis)] = (angle);}};
...
void pidController(const pidProfile_t *pidProfile, const rollAndPitchTrims_t *angleTrim, timeUs_t currentTimeUs)
{
    ...
    for (int axis = FD_ROLL; axis <= FD_YAW; axis++) {
        ...
        {if (debugMode == (DEBUG_ANGLE)) {debug[(axis)] = (currentPidSetpoint);}}
