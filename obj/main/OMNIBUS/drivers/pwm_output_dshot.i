...
void pwmCompleteDshotMotorUpdate(uint8_t motorCount)
{
    ...
    for (int i = 0; i < dmaMotorTimerCount; i++) {
# 97 "./src/main/drivers/pwm_output_dshot.c"
        {
...
void pwmDshotMotorHardwareConfig(const timerHardware_t *timerHardware, uint8_t motorIndex, motorPwmProtocolTypes_e pwmProtocolType, uint8_t output)
{
    ...
    if (dmaRef == 
# 144 "./src/main/drivers/pwm_output_dshot.c" 3 4
                 ((void *)0)
# 144 "./src/main/drivers/pwm_output_dshot.c"
                     ) {
        return;
    }
    ...
    const 
# 162 "./src/main/drivers/pwm_output_dshot.c" 3 4
         _Bool 
# 162 "./src/main/drivers/pwm_output_dshot.c"
...
# 221 "./src/main/drivers/pwm_output_dshot.c"
    {
...
# 257 "./src/main/drivers/pwm_output_dshot.c"
    {
...
# 274 "./src/main/drivers/pwm_output_dshot.c"
    ...
    motor->configured = 
# 289 "./src/main/drivers/pwm_output_dshot.c" 3 4
                       1
# 289 "./src/main/drivers/pwm_output_dshot.c"
                           ;
}
