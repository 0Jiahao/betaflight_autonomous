...
# 32 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 34 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 84 "./src/main/drivers/bus_i2c_impl.h"
        pullUp;
# 93 "./src/main/drivers/bus_i2c_impl.h"
} i2cDevice_t;

extern i2cDevice_t i2cDevice[];
# 35 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
# 44 "./src/main/drivers/bus_i2c_stm32f30x.c"
...
const i2cHardware_t i2cHardware[2] = {
    ...
    {
        .device = I2CDEV_1,
        .reg = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)),
        .sclPins = { { ((ioTag_t)((((0) + 1) << 4) | (15))) }, { ((ioTag_t)((((1) + 1) << 4) | (6))) }, { ((ioTag_t)((((1) + 1) << 4) | (8))) } },
        .sdaPins = { { ((ioTag_t)((((0) + 1) << 4) | (14))) }, { ((ioTag_t)((((1) + 1) << 4) | (7))) }, { ((ioTag_t)((((1) + 1) << 4) | (9))) } },
        .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00200000))>65535L) + (8*(((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L)) >>8*(((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L)) >>8*(((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L))>255))/2+1))))),
    },
# 67 "./src/main/drivers/bus_i2c_stm32f30x.c"
};
...
uint32_t i2cTimeoutUserCallback(void)
{
    i2cErrorCount++;
    return 
# 78 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
          0
# 78 "./src/main/drivers/bus_i2c_stm32f30x.c"
               ;
}
...
void i2cInit(I2CDevice device)
{
    ...
    RCC_I2CCLKConfig(I2Cx == ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) ? ((uint32_t)0x10000020) : ((uint32_t)0x00000010));

    IOInit(scl, OWNER_I2C_SCL, (device + 1));
    IOConfigGPIOAF(scl, pDev->pullUp ? ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_UP) << 5)) : ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x04));

    IOInit(sda, OWNER_I2C_SDA, (device + 1));
    IOConfigGPIOAF(sda, pDev->pullUp ? ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_UP) << 5)) : ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x04));
    ...
    I2C_InitTypeDef i2cInit = {
        ...
        .I2C_Timing = (pDev->overClock ? 0x00500E30 : 0x00E0257A)
    };
...
# 130 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
_Bool 
# 130 "./src/main/drivers/bus_i2c_stm32f30x.c"
    i2cWrite(I2CDevice device, uint8_t addr_, uint8_t reg, uint8_t data)
{
    if (device == I2CINVALID || device > 2) {
        return 
# 133 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
              0
# 133 "./src/main/drivers/bus_i2c_stm32f30x.c"
                   ;
    }
    ...
    if (!I2Cx) {
        return 
# 139 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
              0
# 139 "./src/main/drivers/bus_i2c_stm32f30x.c"
                   ;
    }
    ...
    i2cTimeout = ((uint32_t)(10 * ((uint32_t)0x1000)));
    ...
    return 
# 200 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
          1
# 200 "./src/main/drivers/bus_i2c_stm32f30x.c"
              ;
}


# 203 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
_Bool 
# 203 "./src/main/drivers/bus_i2c_stm32f30x.c"
    i2cRead(I2CDevice device, uint8_t addr_, uint8_t reg, uint8_t len, uint8_t* buf)
{
    if (device == I2CINVALID || device > 2) {
        return 
# 206 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
              0
# 206 "./src/main/drivers/bus_i2c_stm32f30x.c"
                   ;
    }
    ...
    if (!I2Cx) {
        return 
# 212 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
              0
# 212 "./src/main/drivers/bus_i2c_stm32f30x.c"
                   ;
    }
    ...
    return 
# 281 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
          1
# 281 "./src/main/drivers/bus_i2c_stm32f30x.c"
              ;
}
